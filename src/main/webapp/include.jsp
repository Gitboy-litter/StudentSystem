        ...
        <ul id="nav_all">
            ...
            <li><a href="#">管理</a>
                <ul style="display: none;">
                    ...
                    <li><a href="/selectstudent">学生管理</a></li>
                    <li><a href="/selectteacher">教师管理</a></li>
                    <li><a href="http://sc.chinaz.com/">课程管理</a></li>
                    <li><a href="http://sc.chinaz.com/">院系管理</a></li>
                </ul>
            </li>
            <li><a href="/selectteacher">选课</a>
                <ul style="display: none;">
                    <li style="width: 30px;"></li>
            ...
            <li><a href="http://sc.chinaz.com/">信息查看</a>
                <ul style="display: none;">
                    ...
                    <li><a href="/selectstudent?id=2"><b>查看学生信息</b></a></li>
                    <li><a href="/selectteacher?id=2">查看教师信息</a></li>
                    <li><a href="http://sc.chinaz.com/">查看院系信息</a></li>
                    <li><a href="http://sc.chinaz.com/">查看课程信息</a></li>
                    <li><a href="http://sc.chinaz.com/">查看选课信息</a></li>
                </ul>
            </li>
            <li style="margin-left: 200px"><a href="/exit">退出</a>
            </li>
            <%--<li><a href="http://sc.chinaz.com/">注销</a>--%>
            </li>
            <li><a type="text">当前用户:${sessionScope.get("username")}</a>
            </li>
